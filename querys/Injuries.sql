DECLARE
    BEGIN
        ...
        ops.go(
            ops.reduce_ra('Eng_Eng_Pair', 'aircr_id, eng_mfrr=eng.eng_mfrr, eng_serial_num=eng.eng_serial_num', ops.allcols('Eng_Eng_Pair'), 'Eng_Aircr_id_Hr_Count')
        );
...
-- Second natural join
        ...
        ops.go(
            ops.reduce_ra('Eng_Event_Pair', 'aircr_id=evt.aircr_id', 'evt_number, evt_injury_count, eng_tot_hr_count', 'Eng_Aircr_ID')
        );
