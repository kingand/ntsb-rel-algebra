CREATE TABLE ntsb_event(
    ...
    geo_location_latitude NUMBER(4,10) REFERENCES ntsb_geo_location(geo_location_latitude),
    geo_location_longitude NUMBER(4,10) REFERENCES ntsb_geo_location(geo_location_longitude),
